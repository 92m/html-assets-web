...
let modernAssetsManifestPath = path.resolve(process.cwd(), './dist/modern-assets-manifest.json')
let lagacyAssetsManifestPath = path.resolve(process.cwd(), './dist/legacy-assets-manifest.json')
