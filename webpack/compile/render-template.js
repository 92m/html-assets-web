...
const { defaultAssetsConfig } = require('../config/split-chunk.conf')
...
const { loadModernManifest, loadLagacyManifest } = require('../utils/load-assets-manifest')
